...
const translations = {
  it: {
    ...
    'home.subtitle': 'Genera idee innovative con l\'intelligenza artificiale. Trasforma i tuoi pensieri in progetti straordinari.',
    'home.randomIdea': 'Idea Casuale',
    'home.randomDescription': 'Lascia che l\'AI generi un\'idea completamente nuova per te',
    'home.customIdea': 'Idea Personalizzata',
    'home.customDescription': 'Descrivi quello che hai in mente e lascia che l\'AI lo sviluppi',
    ...
    'home.noIdeasDescription': 'Clicca su uno dei pulsanti sopra per iniziare il tuo viaggio creativo',
    ...
    // Home page additions
    'home.customPlaceholder': 'Descrivi la tua idea o il tema che ti interessa...',
    'home.startGenerating': 'Inizia a generare idee',
    'home.startDescription': 'Clicca su uno dei pulsanti sopra per iniziare il tuo viaggio creativo',
    ...
    // Prompt descriptions
    'prompts.startupDesc': 'Sviluppa un\'idea di startup innovativa che si concentri sulla sostenibilità e la protezione ambientale',
    'prompts.scifiDesc': 'Crea una storia di fantascienza avvincente ambientata nel prossimo futuro',
    'prompts.techDesc': 'Progetta un prodotto tecnologico innovativo che migliori la vita quotidiana delle persone',
    'prompts.musicDesc': 'Sviluppa un progetto musicale creativo o un concetto per diversi generi o strumenti',
    'prompts.wellnessDesc': 'Concepisci un\'app per la salute e il benessere che offra soluzioni personalizzate agli utenti',
    'prompts.appNameDesc': 'Genera un nome creativo e memorabile per un\'app mobile, inclusa una breve descrizione',
    'prompts.everydayDesc': 'Identifica un problema quotidiano e sviluppa una soluzione pratica e innovativa',
  },
  ...
  en: {
    ...
    'home.subtitle': 'Generate innovative ideas with artificial intelligence. Transform your thoughts into extraordinary projects.',
    ...
    'home.customDescription': 'Describe what you have in mind and let AI develop it',
    ...
    'home.noIdeasDescription': 'Click one of the buttons above to start your creative journey',
    ...
    // Home page additions
    'home.customPlaceholder': 'Describe your idea or the topic that interests you...',
    'home.startGenerating': 'Start generating ideas',
    'home.startDescription': 'Click one of the buttons above to start your creative journey',
    ...
    // Prompt descriptions
    'prompts.startupDesc': 'Develop an innovative startup idea that focuses on sustainability and environmental protection',
    'prompts.scifiDesc': 'Create a compelling science fiction story set in the near future',
    'prompts.techDesc': 'Design an innovative technology product that improves people\'s daily lives',
    'prompts.musicDesc': 'Develop a creative music project or concept for different genres or instruments',
    'prompts.wellnessDesc': 'Conceive a health and wellness app that offers personalized solutions for users',
    'prompts.appNameDesc': 'Generate a creative and memorable name for a mobile app, including a brief description',
    'prompts.everydayDesc': 'Identify an everyday problem and develop a practical, innovative solution',
  },
  ...
  de: {
    ...
    'home.subtitle': 'Generiere innovative Ideen mit künstlicher Intelligenz. Verwandle deine Gedanken in außergewöhnliche Projekte.',
    'home.randomIdea': 'Zufällige Idee',
    'home.randomDescription': 'Lass die KI eine völlig neue Idee für dich generieren',
    'home.customIdea': 'Benutzerdefinierte Idee',
    'home.customDescription': 'Beschreibe was du im Kopf hast und lass die KI es entwickeln',
    ...
    'home.noIdeasDescription': 'Klicke auf einen der Buttons oben um deine kreative Reise zu beginnen',
    'home.generateFirst': 'Erste Idee generieren',
    'home.placeholder': 'Beschreibe deine Idee oder das Thema das dich interessiert...',
    ...
    'ideas.emptyDescription': 'Beginne deine ersten kreativen Ideen zu generieren',
    'ideas.count': 'Ideen',
    ...
    'stats.noStatsDescription': 'Generiere einige Ideen um Statistiken zu sehen',
    ...
    // Home page additions
    'home.customPlaceholder': 'Beschreibe deine Idee oder das Thema das dich interessiert...',
    'home.startGenerating': 'Beginne Ideen zu generieren',
    'home.startDescription': 'Klicke auf einen der Buttons oben um deine kreative Reise zu beginnen',
    ...
    // Prompt descriptions
    'prompts.startupDesc': 'Entwickle eine innovative Startup-Idee, die sich auf Nachhaltigkeit und Umweltschutz konzentriert',
    'prompts.scifiDesc': 'Erstelle eine fesselnde Science-Fiction-Geschichte, die in der nahen Zukunft spielt',
    'prompts.techDesc': 'Entwirf ein innovatives Technologieprodukt, das den Alltag der Menschen verbessert',
    'prompts.musicDesc': 'Entwickle ein kreatives Musikprojekt oder -konzept für verschiedene Genres oder Instrumente',
    'prompts.wellnessDesc': 'Konzipiere eine App für Gesundheit und Wohlbefinden, die personalisierte Lösungen für Nutzer bietet',
    'prompts.appNameDesc': 'Generiere einen kreativen und einprägsamen Namen für eine mobile App, inklusive einer kurzen Beschreibung',
    'prompts.everydayDesc': 'Identifiziere ein alltägliches Problem und entwickle eine praktische, innovative Lösung',
  },
  ...
  fr: {
    ...
    'home.subtitle': 'Générez des idées innovantes avec l\'intelligence artificielle. Transformez vos pensées en projets extraordinaires.',
    'home.randomIdea': 'Idée Aléatoire',
    'home.randomDescription': 'Laissez l\'IA générer une idée complètement nouvelle pour vous',
    'home.customIdea': 'Idée Personnalisée',
    'home.customDescription': 'Décrivez ce que vous avez en tête et laissez l\'IA le développer',
    ...
    'home.noIdeasDescription': 'Cliquez sur l\'un des boutons ci-dessus pour commencer votre voyage créatif',
    ...
    'ideas.noResultsDescription': 'Essayez de modifier les filtres de recherche',
    'ideas.empty': 'Aucune idée encore',
    'ideas.emptyDescription': 'Commencez à générer vos premières idées créatives',
    'ideas.count': 'idées',
    ...
    'stats.noStatsDescription': 'Générez quelques idées pour voir les statistiques',
    ...
    // Home page additions
    'home.customPlaceholder': 'Décrivez votre idée ou le sujet qui vous intéresse...',
    'home.startGenerating': 'Commencer à générer des idées',
    'home.startDescription': 'Cliquez sur l\'un des boutons ci-dessus pour commencer votre voyage créatif',
    ...
    // Prompt descriptions
    'prompts.startupDesc': 'Développez une idée de startup innovante qui se concentre sur la durabilité et la protection de l\'environnement',
    'prompts.scifiDesc': 'Créez une histoire de science-fiction captivante se déroulant dans un futur proche',
    'prompts.techDesc': 'Concevez un produit technologique innovant qui améliore la vie quotidienne des gens',
    'prompts.musicDesc': 'Développez un projet musical créatif ou un concept pour différents genres ou instruments',
    'prompts.wellnessDesc': 'Concevez une application de santé et bien-être qui offre des solutions personnalisées aux utilisateurs',
    'prompts.appNameDesc': 'Générez un nom créatif et mémorable pour une application mobile, incluant une brève description',
    'prompts.everydayDesc': 'Identifiez un problème quotidien et développez une solution pratique et innovante',
  },
  ...
  es: {
    ...
    'home.subtitle': 'Genera ideas innovadoras con inteligencia artificial. Transforma tus pensamientos en proyectos extraordinarios.',
    'home.randomIdea': 'Idea Aleatoria',
    'home.randomDescription': 'Deja que la IA genere una idea completamente nueva para ti',
    'home.customIdea': 'Idea Personalizada',
    'home.customDescription': 'Describe lo que tienes en mente y deja que la IA lo desarrolle',
    ...
    'home.noIdeasDescription': 'Haz clic en uno de los botones de arriba para comenzar tu viaje creativo',
    ...
    'home.startDescription': 'Haz clic en uno de los botones de arriba para comenzar tu viaje creativo',
    ...
    // Prompt descriptions
    'prompts.startupDesc': 'Desarrolla una idea de startup innovadora que se enfoque en la sostenibilidad y protección ambiental',
    'prompts.scifiDesc': 'Crea una historia de ciencia ficción cautivadora ambientada en el futuro cercano',
    'prompts.techDesc': 'Diseña un producto tecnológico innovador que mejore la vida diaria de las personas',
    'prompts.musicDesc': 'Desarrolla un proyecto musical creativo o concepto para diferentes géneros o instrumentos',
    'prompts.wellnessDesc': 'Concibe una app de salud y bienestar que ofrezca soluciones personalizadas para usuarios',
    'prompts.appNameDesc': 'Genera un nombre creativo y memorable para una aplicación móvil, incluyendo una breve descripción',
    'prompts.everydayDesc': 'Identifica un problema cotidiano y desarrolla una solución práctica e innovadora',
  }
};
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const savedLanguage = localStorage.getItem('creativeMuseLanguage') as Language
