...
export function AdvancedPromptSettings({
  ...
  const creativityLevels = [
    {
      value: 1,
      label: '1 - Sehr konservativ',
      description: 'Bewährte, sichere Ansätze',
    },
    {
      value: 2,
      label: '2 - Konservativ',
      description: 'Leichte Variationen bekannter Ideen',
    },
    {
      value: 3,
      label: '3 - Moderat',
      description: 'Ausgewogene Herangehensweise',
    },
    {
      value: 4,
      label: '4 - Kreativ',
      description: 'Neue Kombinationen und Ansätze',
    },
    {
      value: 5,
      label: '5 - Ausgewogen',
      description: 'Standard-Kreativitätslevel',
    },
    {
      value: 6,
      label: '6 - Innovativ',
      description: 'Unkonventionelle Lösungen',
    },
    {
      value: 7,
      label: '7 - Sehr innovativ',
      description: 'Mutige, neue Ideen',
    },
    {
      value: 8,
      label: '8 - Experimentell',
      description: 'Riskante, experimentelle Ansätze',
    },
    { value: 9, label: '9 - Radikal', description: 'Völlig neue Denkweisen' },
    {
      value: 10,
      label: '10 - Revolutionär',
      description: 'Paradigmenwechsel und Disruption',
    },
  ];
  ...
  const removeTag = (tagToRemove: string) => {
    updateSettings({
      preferredTags: settings.preferredTags.filter(
        (tag) => tag !== tagToRemove
      ),
    });
  };
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-sm font-medium">
                  Standard-Kreativitätslevel
                </label>
                <Select
                  value={settings.defaultCreativityLevel.toString()}
                  onValueChange={(value: string) =>
                    updateSettings({ defaultCreativityLevel: parseInt(value) })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value: string) =>
                    setNewPrompt({
                      ...newPrompt,
                      creativityLevel: parseInt(value),
                    })
                  }
                >
                  <SelectTrigger>
